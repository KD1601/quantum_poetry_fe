...
const LanguageSelector = () => {
  ...
  const [activeLanguage, setActiveLanguage] = useState(localStorage.getItem('selectedLanguage') || null)
  ...
  const handleInputSubmit = () => {
    if (inputValue.trim()) {
      // Chuyển hướng sang /feature và truyền từ user nhập vào qua state
      navigate('/feature', { state: { word: inputValue, language: selectedLanguage } })
    }
  }
